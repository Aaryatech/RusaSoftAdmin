						...
						<header class="panel_header">
							...
							<div class="actions panel_actions pull-right">
								<c:if test="${addAccess == 0}">
									<a
										href="${pageContext.request.contextPath}/addPlagirsmDetactSoftwr"><button
							...
							<div class="row">
								<div class="col-md-12">
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/deleteSelPlagiarismCodeEthics/0/<%out.println(hashtext);%>"
															...
															<c:forEach items="${plagrismList}" var="plgList"
																...
																<tr>
																	<td align="center"><input type="checkbox"
																		class="chk" name="plagIds"
																		id="plagIds${count.index+1}"
																	...
																	<td align="center"><c:if test="${editAccess==0}">
																			...
																			<a
																				href="${pageContext.request.contextPath}/deletePlagrismEthicsCode/${plgList.plagCodeEthcId}/<%out.println(hashtext);%>"
