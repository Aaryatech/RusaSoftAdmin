						...
						<header class="panel_header">
							...
							<div class="actions panel_actions pull-right">
								<c:if test="${addAccess == 0}">
									<a href="${pageContext.request.contextPath}/newInstResrchDevMous"><button
							...
							<div class="row">
								<div class="col-md-12">
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/deleteSelMouResrchDev/0"
													...
													<c:forEach items="${rsrchMouList}" var="mouList"
														...
														<tr>
															...
															<td style="text-align: center;"><c:if
																	test="${editAccess == 0}">
																	<a href="${pageContext.request.contextPath}/editRsrchMou/${mouList.instReasearchDevMouId}"><span
																		class="glyphicon glyphicon-edit" title="Edit"
																		data-original-title="Edit"
																		data-animate=" animated fadeIn " rel="tooltip"></span></a>
																</c:if> <c:if test="${deleteAccess == 0}">
																&nbsp;&nbsp;&nbsp;&nbsp; <a
																		href="${pageContext.request.contextPath}/deleteRsrchMou/${mouList.instReasearchDevMouId}"
