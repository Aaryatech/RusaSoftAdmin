														...
														<tbody>
															<c:forEach items="${awrdRecg}" var="list"
																...
																<tr>
																	...
																	<td>${list.actName}</td>
																	<td>${list.awardRecogName}</td>
																	<td>${list.nameAwardingBody}</td>
																	<td>${list.awardYear}</td>
																	<td align="center"><c:if test="${editAccess==0}">
																			...
																			<a
																				href="${pageContext.request.contextPath}/deleteAwrdRecg/${list.awrdRecgAgnstExtActId}"
