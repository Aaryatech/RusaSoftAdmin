							...
							<div class="row">
								<div class="col-md-12">
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/deleteSelExtsnActivities/0/<%out.println(hashtext);%>"
														...
														<tbody>
															<c:forEach items="${mExtActList}" var="extActList"
																...
																<tr>
																	...
																	<td>${extActList.noOfFacultyInInst}</td>
																	<td align="center"><c:if test="${editAccess==0}">
																			...
																			<a
																				href="${pageContext.request.contextPath}/deleteTExtActivity/${extActList.instExtensionActId}/<%out.println(hashtext);%>"
