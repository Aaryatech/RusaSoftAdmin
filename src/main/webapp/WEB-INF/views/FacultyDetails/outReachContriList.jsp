...
<%
							...
							<div class="row">
								<div class="col-md-12">
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/deleteOutReahContri/0/<%out.println(hashtext);%>"
										method="get" 
												...
												<div>
													...
													<tr>
														...
														<td align="center"><c:if test="${editAccess==0}"> 
																...
																<a
																	href="${pageContext.request.contextPath}/deleteContribtn/${contribtn.conId}/<%out.println(hashtext);%>"
	...
	function selectedInst(source) {
		...
		checkboxes = document.getElementsByName('facContId');
