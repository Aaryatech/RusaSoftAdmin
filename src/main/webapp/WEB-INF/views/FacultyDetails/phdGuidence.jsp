									...
									<form class="form-horizontal"
										...
										<div>
											...
											<div class="col-xs-12">
												...
												<input type="hidden" id="phdGiudeId" name="phdGiudeId"
													value="${phd.phdId}">
												<div class="form-group">
													...
													<div class="col-sm-4">
														...
														Yes <input type="radio" name="phdGuide" id="phdGuide"
															onclick="checkPhdGuide(this.value)" value="1"
															${phd.isPhdGuide == 1 ? 'checked' : '' }> No<input
															type="radio" name="phdGuide" id="phdGuide" value="0"
															onclick="checkPhdGuide(this.value)"
												...
												<div class="form-group" id="ihide" style="display: none;">
													...
													<div class="form-group">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control" id="phd_scholar"
																onchange="trim(this)" name="phd_scholar"
																placeholder="Name of Ph.D Scholar"
																value="${phd.phdScholarName}" autocomplete="off">
															<span class="error_form text-danger"
																id="error_formfield2" style="display: none;">Please
																enter name of Ph.D. scholar.</span>
														</div>
													</div>

													<div class="form-group">
														<label class="control-label col-sm-2" for="smallheading">Aadhaar
															No. of Ph.D. Scholar <span class="text-danger"></span>
														</label>
														<div class="col-sm-6">
															<input type="text" class="form-control" id="aadhar"
																onchange="trim(this)" name="aadhar"
																placeholder="Aadhaar No." maxlength="15"
													...
													<div class="form-group">
														<label class="control-label col-sm-2" for="smallheading">Place/Name
															of Research Center<span class="text-danger">*</span>
														</label>
														<div class="col-sm-6">
															<input type="text" class="form-control" id="place_work"
																onchange="trim(this)" name="place_work"
																placeholder="Place/Name of Research Center"
																value="${phd.placeOfWork}" autocomplete="off"> <span
																class="error_form text-danger"
																id="error_field_place_work" style="display: none;">
													...
													<div class="form-group">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control" id="university"
																onchange="trim(this)" name="university"
																placeholder="University" value="${phd.university}"
																autocomplete="off"> <span
																class="error_form text-danger"
																id="error_field_univrsity" style="display: none;">Please
																enter university.</span>
														</div>
													</div>

													<div class="form-group">
														<label class="control-label col-sm-2" for="smallheading">Department
															Of Scholar <span class="text-danger">*</span>
														</label>
														<div class="col-sm-6">
															<input type="text" class="form-control"
																id="phd_scholar_depart" onchange="trim(this)"
																name="phd_scholar_depart"
																placeholder="Department of Scholar"
																value="${phd.exVar1}" autocomplete="off"> <span
																class="error_form text-danger" id="error_formfield0"
																style="display: none;">Please enter department
																of scholar.</span>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-6">
															<select id="phd_year_reg" name="phd_year_reg"
																class="form-control">
													...
													<div class="form-group">
														...
														<div class="col-sm-6">
															<textarea id="phd_topic" name="phd_topic"
																...
																style="width: 100%;">${phd.phdTopic}</textarea>
															<span class="error_form text-danger"
																id="error_formfield3" style="display: none;">Please
																enter title of thesis.</span>
														</div>
													</div>
 ...
 -->
														...
														<div class="col-sm-2">
															...
															Yes <input type="radio" name="awarded" id="awarded"
																${phd.isPhdAwarded == 1 ? 'checked' : '' } value="1"
																onclick="check(this.value)"> No<input
																type="radio" name="awarded" id="awarded"
																${phd.isPhdAwarded == 0 ? 'checked' : '' } value="0"
													...
													<div class="form-group" id="abc" style="display: none;">
														...
														<div class="col-sm-6">
															<select id="phd_year_awarded" name="phd_year_awarded"
																class="form-control" required>

																<c:forEach items="${acaYearList}" var="acaYearList">
																	<c:choose>
																		<c:when
																			test="${acaYearList.yearId==phd.phdAwardedYear}">
																			<option selected value="${acaYearList.yearId}">${acaYearList.academicYear}</option>
													...
													<div class="form-group" id="cogid" style="display: none;">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control "
																id="co_guide_name" autocomplete="off"
																onchange="trim(this)" name="co_guide_name"
																placeholder="Name of Co_Guide"
																value="${phd.coGuideName}"> <span
												...
												<div class="form-group">
													<div class="col-sm-offset-2 col-sm-10">
														...
														<a
															href="${pageContext.request.contextPath}/showPhdGuideList"><button
		...
		<script type="text/javascript">
			...
			function check(qualType) {
				...
				if (qualType == 1) {
					...
					document.getElementById("phd_year_awarded").setAttribute(
							"required", "true");

				} else if (qualType == 0) {
					document.getElementById("abc").style = "display:none"
					document.getElementById("phd_year_awarded").style = "display:none"
					document.getElementById("phd_year_awarded")
