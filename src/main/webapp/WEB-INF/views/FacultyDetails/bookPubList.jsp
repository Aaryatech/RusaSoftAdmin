							...
							<div class="row">
								<div class="col-md-12">
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/deleteFacultyJournal/0/<%out.println(hashtext);%>"
												...
												<c:forEach items="${bookList}" var="bList"
													...
													<tr>
														...
														<td align="center"> <c:if test="${editAccess==0}"> 
																...
																<a
																	href="${pageContext.request.contextPath}/deleteBookPublished/${bList.bookId}/<%out.println(hashtext);%>"
...
<div class="form-group">
	...
	function selectedInst(source) {
		...
		checkboxes = document.getElementsByName('bookId');
