												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														<input type="text" class="form-control" id="book_title"
															...
															name="book_title"
															placeholder="Title of Book,Chapter in edited Volume/proceeding"
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														<input type="text" class="form-control" id="book_edition"
															onchange="trim(this)" autocomplete="off"
															name="book_edition" placeholder="Edition"
															value="${book.bookEdition }"> <span
															class="error_form text-danger" id="error_formfield2"
															style="display: none;">Please enter edition of
															book.</span>
													</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														<input type="text" class="form-control" id="publisher"
															onchange="trim(this)" autocomplete="off" name="publisher"
															placeholder="Name of Publication/Publisher "
															value="${book.bookPublisher}"> <span
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														<input type="text" class="form-control" id="isbn"
															onchange="trim(this)" autocomplete="off" name="isbn"
															placeholder="ISSN/ISBN No." value="${book.bookIsbn }">
														<span class="error_form text-danger" id="error_formfield5"
															style="display: none;">Please enter ISSN/ISBN No.
														</span>
													</div>
 ...
 --%>
												...
												<div class="form-group">
													<div class="col-sm-offset-2 col-sm-10">
														...
														<a
															href="${pageContext.request.contextPath}/showBookPubList"><button
