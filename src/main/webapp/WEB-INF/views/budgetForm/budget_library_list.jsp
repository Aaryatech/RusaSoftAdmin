										...
										<table id="example-1"
											...
											<thead>
												<tr>
													...
													<th>Budget Allocated for Knowledge Resource
														Center(Library) ${budRupees}</th>
													<th>Action</th>
												</tr>
											</thead>
											<tbody>
												<c:forEach items="${budgetList}" var="budget"
													...
													<tr>
														...
														<td align="center"><c:if test="${editAccess==0}">
																...
																<a
																	href="${pageContext.request.contextPath}/deleteLibBudget/${budget.libBudgetId}/<%out.println(hashtext);%>"
