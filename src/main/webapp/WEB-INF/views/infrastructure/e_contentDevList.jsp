         ...
         <header class="panel_header">
                ...
                <div class="actions panel_actions pull-right">
                   <c:if test="${addAccess == 0}">  
               		  <a href="${pageContext.request.contextPath}/addEContentDev"><button type="button" class="btn btn-success">
									...
									<tr>
									 <td><input type="checkbox" class="chk" name="econtent"
											...
											<td style="text-align: left"><c:out
														value="${content.eContentDevFacility}" /></td>
											...
											<td align="center">
												...
												href="${pageContext.request.contextPath}/editEContent/${content.instEContentDevFacilityId}" title="Edit" 
...
<!-- LOAD FILES AT PAGE END FOR FASTER LOADING -->
   ...
   function selectedInst(source) {
		...
		checkboxes = document.getElementsByName('econtent');
