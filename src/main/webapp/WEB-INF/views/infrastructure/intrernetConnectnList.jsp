...
<div class="col-lg-12">
    <section class="box "> 
         ...
         <header class="panel_header">
                ...
                <div class="actions panel_actions pull-right">
                   <c:if test="${addAccess == 0}">  
               		  <a href="${pageContext.request.contextPath}/addInternetConnectnInfo"><button type="button" class="btn btn-success">
        ...
        <div class="col-xs-12">
				<form class="form-horizontal" action="${pageContext.request.contextPath}/delSlectedLanCompInfo/0" method="get"
                ...
                <thead>
                    <tr>
                     <th class="check" style="text-align: center; width: 5%;"><input
                   		...
                   		<th width="5%">Sr No</th>
                        <th>Computers With Internet Access</th> 
                        <th>Leased Line Bandwidth</th> 
                        <th>LAN Configuration Speed</th>
                        <th>Internet Service Provider(ISP) Name</th>
                        <th>Purchase Date</th>      
									...
									<tr>
									 <td align="center"><input type="checkbox" class="chk" name="lanInfoId"
											...
											<td style="text-align: left"><c:out
														value="${connection.noOfCompWithInternetAccess}" /></td>
														
											<td style="text-align: left"><c:out
														value="${connection.leasedLineBandwidth}" /></td>
											
											<td style="text-align: right"><c:out
														value="${connection.lanConfSpeed}" /></td>
											
											
											<td style="text-align: right"><c:out
														value="${connection.ispName}" /></td>
													
												<td style="text-align: right"><c:out
														value="${connection.purchaseDate}" /></td>
												
											<td align="center">
												 <c:if test="${editAccess == 0}">  <a
												href="${pageContext.request.contextPath}/editLanConnectionDetails/${connection.instInternetInfoId}" title="Edit" 
											 ...
											 <c:if test="${deleteAccess == 0}"> 	 
												<a	href="${pageContext.request.contextPath}/deleteLanConnectionDetails/${connection.instInternetInfoId}/<%out.println(hashtext);%>"
...
<!-- LOAD FILES AT PAGE END FOR FASTER LOADING -->
   ...
   function selectedInst(source) {
		...
		checkboxes = document.getElementsByName('lanInfoId');
