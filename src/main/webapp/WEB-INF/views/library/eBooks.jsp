			...
			<div class="modal-content">
				<div class="modal-header">
					<button aria-hidden="true" data-dismiss="modal" class="close"
						type="button">×</button>
					<h4 class="modal-title">e Books</h4>
				</div>
				<div class="modal-body">
					<%-- <form role="form"
						...
						<div class="form-group" id="abc">
							...
							<label class="control-label col-sm-6" for="page_name">No. of Books
							</label>
							<!-- <div class="col-sm-3"> -->
								<input type="text" class="form-control" id="mem" placeholder="No. of Books"
