									...
									<tr>
									 <td align="center"><input type="checkbox" class="chk" name="rareBookId"
											...
											<td align="center">
												...
												href="${pageContext.request.contextPath}/editRareBookInfo/${bookList.rareBookInfoId}" title="Edit" 
											 ...
											 <c:if test="${deleteAccess == 0}"> 	 
												<a	href="${pageContext.request.contextPath}/deleteRareBookInfo/${bookList.rareBookInfoId}/<%out.println(hashtext);%>"
