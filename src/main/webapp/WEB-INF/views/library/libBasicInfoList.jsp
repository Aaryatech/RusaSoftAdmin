...
<div class="col-lg-12">
    <section class="box "> 
         ...
         <header class="panel_header">
                ...
                <div class="actions panel_actions pull-right">
                 <c:if test="${addAccess == 0}"> 
               		  <a href="${pageContext.request.contextPath}/libraryBasicInfo"><button type="button" class="btn btn-success">
        ...
        <div class="col-xs-12">
			<form class="form-horizontal" action="${pageContext.request.contextPath}/delSlectedLibInfo/0"
            ...
            <table id="example-1" class="table table-striped dt-responsive display">
                ...
                <tbody>
                      <c:forEach items="${libInfoList}" var="libList" varStatus="count"> 
									<tr>
