				...
				<div class="modal-body">
					<%-- <form role="form"
						...
						<input type="hidden" class="form-control" id="pageId"
							...
							<div class="form-group">
							<label class="control-label col-sm-6" for="page_order">Is Database
						...
						<div class="form-group" id="abc">
							...
							<label class="control-label col-sm-6" for="page_name">No. of Database
							</label>
							<!-- <div class="col-sm-3"> -->
								<input type="text" class="form-control" id="mem" placeholder="No. of Database"
