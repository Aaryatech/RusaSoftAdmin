            ...
            <table id="example-1" class="table table-striped dt-responsive display">
                ...
                <tbody>
                      <c:forEach items="${bookList}" var="libBook" varStatus="count"> 
									<tr>
									 <td align="center"><input type="checkbox" class="chk" name="libBookId"
											...
											<td align="center">
											 ...
											 <c:if test="${deleteAccess == 0}"> 	 
												<a	href="${pageContext.request.contextPath}/deleteLibBook/${libBook.bookPurchaseId}/<%out.println(hashtext);%>"
