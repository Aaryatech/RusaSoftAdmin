						...
						<header class="panel_header">
							...
							<div class="actions panel_actions pull-right">
								<c:if test="${addAccess==0}">
									<a href="${pageContext.request.contextPath}/addNewCourseInfo"><button
											...
											<tbody>
												<c:forEach items="${courseList}" var="courseList"
													...
													<tr>
														...
														<td align="left">${courseList.progType}-${courseList.progName}</td>
														<td align="left">${courseList.applicableYear}</td>														
														<td align="right">${courseList.courseName}</td>
														<td align="left">${courseList.courseCode}</td>
														<td align="left">${courseList.introduceFrom}</td>
														<td align="right">${courseList.document}</td>

														<td align="center"><c:if test="${editAccess==0}">
														<a href="${pageContext.request.contextPath}/editCourseInfo/${courseList.courseId}">
															<span class="glyphicon glyphicon-edit" title="Edit"
																	data-animate=" animated fadeIn " rel="tooltip"></span></a>&nbsp;&nbsp;&nbsp;&nbsp; </c:if>
															<c:if test="${deleteAccess==0}">
																<a
																	href="${pageContext.request.contextPath}/deleteCourseInfo/${courseList.courseId}/<%out.println(hashtext);%>"
