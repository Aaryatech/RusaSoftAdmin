						...
						<header class="panel_header">
							...
							<div class="actions panel_actions pull-right">
								<c:if test="${addAccess==0}">
									<a href="${pageContext.request.contextPath}/addFieldProject"><button
											...
											<tbody>
												<c:forEach items="${fieldList}" var="fieldList"
													...
													<tr>
														...
														<td align="left">${fieldList.programName}-${fieldList.programType}</td>
														<td align="left">${fieldList.provisionForUndertaking}</td>														
														<td align="right">${fieldList.noOfStudUndertaking}</td>
														<td align="left">${fieldList.document}</td>
														
														<td align="center"><c:if test="${editAccess==0}">
														<a href="${pageContext.request.contextPath}/editProjectintern/${fieldList.fieldProjectInternId}">
															<span class="glyphicon glyphicon-edit" title="Edit"
																	data-animate=" animated fadeIn " rel="tooltip"></span></a>&nbsp;&nbsp;&nbsp;&nbsp; </c:if>
															<c:if test="${deleteAccess==0}">
																<a
																	href="${pageContext.request.contextPath}/deleteProjectintern/${fieldList.fieldProjectInternId}/<%out.println(hashtext);%>"
