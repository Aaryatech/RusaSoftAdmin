								...
								<div class="col-md-12">
									...
									<ul class="nav nav-tabs">
										...
										<li><a href="#PEO" data-toggle="tab"> <i
												class="fa fa-home"></i> Human value and Professioinal Ethics
										</a></li>
										...
										<div class="tab-pane fade in " id="Mission">
											...
											<form class="form-horizontal" action="#" method="post"
												...
												<c:if test="${instituteYesNoTab2List.size()==0}">
													<div class="row">
														<label class="col-sm-3 text-left" for="programVission">
															Environment and Sustainability <span class="text-danger">*</span>
														</label>
														<div class="col-sm-6">
