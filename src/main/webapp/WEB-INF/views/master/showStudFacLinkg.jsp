...
<body class=" ">
						...
						<header class="panel_header">
							...
							<div class="actions panel_actions pull-right">
							 <c:if test="${addAccess == 0}">  
								<a href="${pageContext.request.contextPath}/addStudFacLinkage"><button
							...
							<div class="row">
								<div class="col-md-12">
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/deleteSelStudFacLinks/0/<%out.println(hashtext);%>"
										method="get" 
												...
												<div>
													...
													<tr>
														...
														<td align="center"><c:if test="${editAccess==0}"> 
																...
																<a
																	href="${pageContext.request.contextPath}/deleteLinkage/${links.facultyStudLinkageId}/<%out.println(hashtext);%>"
	...
	function selectedInst(source) {
		...
		checkboxes = document.getElementsByName('linkageId');
