...
<!-- BEGIN BODY -->
<body onload="setDate(${trnPlaceOff.isWorking})">
							...
							<div class="row">
								<div class="col-md-12">
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/insertTrainingandPlacementOff"
													...
													<div class="col-sm-10">
														<select id="designation" name="designation"
															...
															<c:forEach items="${desigList}" var="makeList">
																<c:choose>
																	<c:when
																		test="${makeList.designationId == trnPlaceOff.currentDesignationId}">
													...
													<div class="col-sm-10">
														<select id="hod_quolf" name="quolif" class="form-control">
															<c:forEach items="${quolfList}" var="quolf">
																<c:choose>
																	<c:when
																		test="${trnPlaceOff.highestQualification==quolf.qualificationId}">
            		...
            		$("#form_sample_2").submit(function(e) {
            			...
            			var isError=false;
            			 var errMsg="";
           				...
           				if(!$("#pacementOfficerName").val()){
            					 
            				isError=true;
            				errMsg += '<li>Please enter a valid name.</li>';
            				
            				$("#pacementOfficerName").addClass("has-error")
...
/* $(function () {
 ...
 $(this).val($(this).val().replace(/[^0-9\.]/g,''));
	...
	function showIsReg(){
		//alert("Hi");
		var x=${trnPlaceOff.facultyId};
	
		if(x>0){
			//alert("Hi 1")
		var isRel=${trnPlaceOff.realivingDate};
		//alert("Is Reg " +isReg);
		if(isRel==null){
			//alert("Hi 2")
			document.getElementById("abc").style.display = "none";
