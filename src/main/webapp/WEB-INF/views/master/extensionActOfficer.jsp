								...
								<div class="col-md-12">
									<form class="form-horizontal"
										...
										<div>
											...
											<input type="hidden" class="form-control" id="extActOfficerId"
												name="extActOfficerId" value="${extActOff.facultyId}"> <input
											...
											<div class="col-xs-12">
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" id="extActOfficerName"
															name="extActOfficerName" placeholder="Extension Activity Officer Name"
															onchange="trim(this)" autocomplete="off"
															value="${extActOff.facultyFirstName}"> <span
															class="error_form text-danger" id="error_formfield1"
															style="display: none;">Please enter extension activity officer name</span>
													</div>
												</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-3">
													...
													Yes <input type="radio" ${extActOff.isSame == 1 ? 'checked' : ''} name="is_state_same" id="is_state_same" value="1" onclick="selcState()"> 
													No<input type="radio" ${extActOff.isSame == 0 ? 'checked' : ''} name="is_state_same" id="is_state_same" value="0" onclick="selcState()">
													</c:if>
											...
											<div class="col-sm-10">
												<select id="state_id" name="state_id" class="form-control">
													 ...
													 <c:forEach items="${sessionScope.stateList}" var="state">
														<c:choose>
														<c:when test="${extActOff.facultyMiddelName == state.stateId}">
										...
										<div class="form-group">
											<div class="col-sm-offset-2 col-sm-10">
												...
												<a href="${pageContext.request.contextPath}/showExternalActivities"><button
