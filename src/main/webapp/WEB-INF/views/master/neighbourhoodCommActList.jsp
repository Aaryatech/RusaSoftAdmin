						...
						<header class="panel_header">
							...
							<div class="actions panel_actions pull-right">
								<c:if test="${addAccess == 0}">
									<a href="${pageContext.request.contextPath}/newNeighbourhoodCommAct"><button
...
<%
														...
														<tbody>
															<c:forEach items="${neighbrCommActList}" var="neighbourList"
																...
																<tr>
																	...
																	<td>${neighbourList.activityName}</td>
																	<td>${neighbourList.noOfStud}</td>
																...
																<c:if test = "${neighbourList.associationWith=='Any Other'}">
																	...
																	<td align="center"><c:if test="${editAccess==0}">
																			<a
																				href="${pageContext.request.contextPath}/editNeighbCommActivity/${neighbourList.instNeighbourhoodCommActId}"><span
																				class="glyphicon glyphicon-edit" title="Edit"
																				data-animate=" animated fadeIn " rel="tooltip"></span></a>&nbsp;&nbsp;&nbsp;&nbsp;
																			 </c:if>
																			<c:if test="${deleteAccess==0}">
																			<a
																				href="${pageContext.request.contextPath}/deleteNeighbCommActivity/${neighbourList.instNeighbourhoodCommActId}/<%out.println(hashtext);%>"
	...
	<script type="text/javascript">
		function selectedInst(source) {
			...
			checkboxes = document.getElementsByName('actId');
