		...
		<section id="main-content" class=" ">
			<section class="wrapper main-wrapper row" style="">
				...
				<div class="col-lg-12">
                   ...
                   <input type="hidden" name="formIndex" id="formIndex"
										value="${formindex}">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<form class="form-horizontal"
										...
										name="form_sample_1" id="form_sample_1"
											...
											<div class="tab-pane fade in active" id="home">
												...
												<div class="col-xs-12"></div> 
													...
													<div class="form-group">
														...
														<label class="control-label col-sm-1" for="smallheading">Mobile
															: <span class="text-danger">*</span>
														</label>

														<div class="col-sm-3">
															<input type="text" class="form-control" id="mobileNo"
																name="mobileNo" pattern="[7-9]{1}[0-9]{9}"
																title="Phone number with 7-9 and remaing 9 digit with 0-9"
													...
													<div class="form-group">
														...
														<div class="col-sm-2">
															<input type="Text" class="form-control" id="adharNo"
																name="adharNo" placeholder="Aadhar No" value="" required>
														</div>
													</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/insertCmsForm"
										method="post" enctype="multipart/form-data"
										name="form_sample_3" id="form_sample_3"
										onsubmit="return confirm('Do you really want to submit the form?');">
													...
													<div class="form-group">
														...
														<div class="col-sm-2">
															<input type="text" class="form-control"
																id="qualification" name="qualification" placeholder="PG"
																value="${page.pageName}" required>
														</div>
														...
														<div class="col-sm-2">
															<input type="text" class="form-control" id="phdNo"
																name="phdNo" placeholder="Ph.D" value="${page.pageName}"
																required>
														</div>
													</div>
													<div class="form-group">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/insertCmsForm"
										method="post" enctype="multipart/form-data"
										name="form_sample_4" id="form_sample_4"
										onsubmit="return confirm('Do you really want to submit the form?');">
											...
											<div class="tab-pane fade in active" id="home">
												...
												<div>
													...
													<div class="form-group">
														...
														<div class="col-sm-2">
															<input type="text" class="form-control" id="dob"
																name="dob" placeholder="Funding from" value="" required>
														</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-3">
															National <input type="radio" name="pub" id="pub" checked
																value="0"> International<input type="radio"
																name="pub" id="pub" value="1">
														</div>
													...
													<div class="form-group">
														...
														<label class="control-label col-sm-2" for="smallheading">Page
															No : <span class="text-danger">*</span>
														</label> <label class="control-label col-sm-1" for="smallheading">From
															: <span class="text-danger">*</span>
														</label>
														<div class="col-sm-2">
															<input type="text" class="form-control" id="dob"
													...
													<div class="form-group">
														...
														<label class="control-label col-sm-2" for="smallheading">Book
															Publication : <span class="text-danger">*</span>
														</label> <label class="control-label col-sm-2" for="smallheading">Title
															of Book : <span class="text-danger">*</span>
														</label>
														<div class="col-sm-4">
															<input type="text" class="form-control" id="dob"
																name="dob" placeholder="Title of Book" value="" required>
														</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/insertCmsForm"
										method="post" enctype="multipart/form-data"
										name="form_sample_5" id="form_sample_5"
										onsubmit="return confirm('Do you really want to submit the form?');">
											...
											<div class="tab-pane fade in active" id="home">
												...
												<div>
													...
													<div class="form-group">
														...
														<div class="col-sm-3">
															<input type="text" class="form-control" id="issue"
																name="issue" placeholder="Sponsoring Authority" value=""
																required>
														</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-4">
															<input type="text" class="form-control" id="dob"
																name="dob" placeholder="Name of Principal Investigator"
																value="" required>
														</div>
														...
														<div class="col-sm-4">
															<input type="text" class="form-control" id="issue"
																name="Department" placeholder="Department Name" value=""
																required>
														</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-4">
															<input type="text" class="form-control" id="dob"
																name="dob"
																placeholder="Name of Co-Principal Investigator" value=""
																required>
														</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-2">
															<input type="text" class="form-control" id="issue"
																name="Total Amount" placeholder="Total Amount" value=""
																required>
														</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/insertCmsForm"
										method="post" enctype="multipart/form-data"
										name="form_sample_6" id="form_sample_6"
										onsubmit="return confirm('Do you really want to submit the form?');">
											...
											<div class="tab-pane fade in active" id="home">
												...
												<div>
													...
													<div class="form-group">
														...
														<div class="col-sm-4">
															<input type="text" class="form-control" id="dob"
																name="Grant" placeholder="Name of Consultancy" value=""
																required>
														</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-2">
															<input type="text" class="form-control" id="dor"
																name="dor" placeholder="Amount of Consultancy" value=""
																required>
														</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/insertCmsForm"
										method="post" enctype="multipart/form-data"
										name="form_sample_7" id="form_sample_7"
										onsubmit="return confirm('Do you really want to submit the form?');">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/insertCmsForm"
										method="post" enctype="multipart/form-data"
										name="form_sample_8" id="form_sample_8"
										onsubmit="return confirm('Do you really want to submit the form?');">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/insertCmsForm"
										method="post" enctype="multipart/form-data"
										name="form_sample_13" id="form_sample_13"
										onsubmit="return confirm('Do you really want to submit the form?');">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/insertCmsForm"
										method="post" enctype="multipart/form-data"
										name="form_sample_9" id="form_sample_9"
										onsubmit="return confirm('Do you really want to submit the form?');">
											...
											<div class="tab-pane fade in active" id="home">
												...
												<div>
													...
													<div class="form-group">
														...
														</label> <label class="control-label col-sm-1" for="smallheading">BOS
															: <span class="text-danger">*</span>
														</label>
														...
														<div class="col-sm-5">
															<input type="text" class="form-control" id="dob"
																name="Grant" placeholder="Name of BOS" value="" required>
														</div>
													...
													<div class="form-group">
														...
														<label class="control-label col-sm-2" for="smallheading">Are
															You Member of : <span class="text-danger">*</span>
														</label> <label class="control-label col-sm-1" for="smallheading">Faculty
															: <span class="text-danger">*</span>
														</label>
													...
													<div class="form-group">
														...
														<label class="control-label col-sm-2" for="smallheading">Are
															You Member of : <span class="text-danger">*</span>
														</label> <label class="control-label col-sm-2" for="smallheading">Academic
															Council : <span class="text-danger">*</span>
														</label>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/insertCmsForm"
										method="post" enctype="multipart/form-data"
										name="form_sample_10" id="form_sample_10"
										onsubmit="return confirm('Do you really want to submit the form?');">
														...
														<table id="example1"
															...
															<thead>
																<tr>
																	...
																	<th width="20%">Subject Type(Regular/Elective/Any
																		other)</th>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/insertCmsForm"
										method="post" enctype="multipart/form-data"
										name="form_sample_11" id="form_sample_11"
										onsubmit="return confirm('Do you really want to submit the form?');">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/insertCmsForm"
										method="post" enctype="multipart/form-data"
										name="form_sample_12" id="form_sample_12"
										onsubmit="return confirm('Do you really want to submit the form?');">
											...
											<div class="tab-pane fade in active" id="home">
												...
												<div>
													...
													<div class="form-group">
														...
														<div class="col-sm-4">
															<input type="text" class="form-control" id="dob"
																name="Grant" placeholder="Name of Ph.D Scholar" value=""
																required>
														</div>
														<label class="control-label col-sm-2" for="smallheading">Year
													...
													<div class="form-group">
														...
														<div class="col-sm-2">
															<input type="date" class="form-control" id="validup"
																name="validup" placeholder="Valid up" value="" required>
														</div>
...
<!-- 														</div>
 -->						</div> --%>
	...
	<div class="form-group">
							<label class="control-label col-sm-3" for="page_name">Year of Passing
							</label>
							<!-- <div class="col-sm-3"> -->
								<input type="date" class="form-control"
								id="curExp" name="curExp" value="" required>
	...
	<script>
		function showForm() {
			var index = document.getElementById("formIndex").value;
			//alert("index" + index);

			//form_sample_2

			document.getElementById("form_sample_1").style = "display:none"
			document.getElementById("form_sample_2").style = "display:none"
				document.getElementById("form_sample_3").style = "display:none"
					document.getElementById("form_sample_4").style = "display:none"
						document.getElementById("form_sample_5").style = "display:none"
							document.getElementById("form_sample_6").style = "display:none"
								document.getElementById("form_sample_7").style = "display:none"
									document.getElementById("form_sample_8").style = "display:none"
										document.getElementById("form_sample_9").style = "display:none"
											document.getElementById("form_sample_10").style = "display:none"
												document.getElementById("form_sample_11").style = "display:none"
													document.getElementById("form_sample_12").style = "display:none"
														document.getElementById("form_sample_13").style = "display:none"
														

			if (index == 1) {

				document.getElementById("form_sample_1").style = "visible"

			} else if (index == 2) {
				document.getElementById("form_sample_2").style = "visible"
			}
			else if (index == 3) {
				document.getElementById("form_sample_3").style = "visible"
			}

			else if (index == 4) {
				document.getElementById("form_sample_4").style = "visible"
			}

			else if (index == 5) {
				document.getElementById("form_sample_5").style = "visible"
			}

			else if (index == 6) {
				document.getElementById("form_sample_6").style = "visible"
			}

			else if (index == 7) {
				document.getElementById("form_sample_7").style = "visible"
			}

			else if (index == 8) {
				document.getElementById("form_sample_8").style = "visible"
			}

			else if (index == 9) {
				document.getElementById("form_sample_9").style = "visible"
			}

			else if (index == 10) {
				document.getElementById("form_sample_10").style = "visible"
			}

			else if (index == 11) {
				document.getElementById("form_sample_11").style = "visible"
			}

			else if (index == 12) {
				document.getElementById("form_sample_12").style = "visible"
			}
			else if (index == 13) {
				document.getElementById("form_sample_13").style = "visible"
			}
