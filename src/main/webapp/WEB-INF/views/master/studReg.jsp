...
<!-- CORE CSS TEMPLATE - END -->newTrainingAndPlacementOfficer
</head>
<!-- END HEAD -->
...
<body class=" ">
 ...
 -->
										<div>
											...
											<div class="col-xs-12">
												<div class="form-group">
													...
													<div class="col-sm-6">
														<input type="text" class="form-control" id="student_name"
															value="${editStudent.studentName}" name="student_name"
															placeholder="Student Name" onchange="trim(this)">
														<span class="error_form text-danger" id="error_name"
															style="display: none;">Please enter Student Name</span>
													...
													<div class="col-sm-6">
														<select id="academic_year" name="academic_year"
															...
															<option value="First Year"
																${editStudent.acadamicYear eq 'First Year' ? 'selected' : '' }>First
																Year</option>
															<option value="Second Year"
																${editStudent.acadamicYear eq 'Second Year' ? 'selected' : '' }>Second
																Year</option>
															<option value="Third Year"
																${editStudent.acadamicYear eq 'Third Year' ? 'selected' : '' }>Third
																Year</option>
															<option value="Fourth Year"
																${editStudent.acadamicYear eq 'Fourth Year' ? 'selected' : '' }>Fourth
																Year</option>
															<option value="Fifth Year"
																${editStudent.acadamicYear eq 'Fifth Year' ? 'selected' : '' }>Fifth
																Year</option>


														</select> <span class="error_form text-danger" id="error_year"
															style="display: none;">Please Select Academic
															Year</span>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														<select id="stud_branch" name="stud_branch"
															class="form-control">
														...
														</select> <span class="error_form text-danger" id="error_dept"
															style="display: none;">Please Select Department</span>
													</div>
												</div>

												<div class="form-group">
													<label class="control-label col-sm-2" for="page_order">ID
														No. <span class="text-danger"></span>
													</label>
													<div class="col-sm-6">
														<input type="text" maxlength="10" class="form-control"
															id="id_number" value="${editStudent.idNo}"
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														<input type="text" maxlength="10" class="form-control"
															id="stud_contact_no" value="${editStudent.contactNo}"
															...
															class="error_form text-danger" id="error_contact"
															style="display: none;">Enter Contact Number</span>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														<input type="email" class="form-control"
															id="student_email" value="${editStudent.email}"
															onchange="checkUnique(this.value,2)" name="student_email"
															placeholder="abc@xyz.com"> <span
															class="error_form text-danger" id="error_email"
															style="display: none;">Enter Proper Email Id </span>
													</div>
												</div>
										...
										<input type="hidden" id="student_id" name="student_id"
											value="${editStudent.studentId}"> <input
