...
<section id="main-content" class=" ">
    ...
    <div class="col-xs-12">
        <div class="page-title">
            ...
            <div class="pull-left">
                <!-- PAGE HEADING TAG - START --><h1 class="title">IQAC Registration</h1><!-- PAGE HEADING TAG - END -->                            </div>
        ...
        <section class="box ">
                ...
                <header class="panel_header">
                    ...
                    <div class="actions panel_actions pull-right">
                	      <a href="${pageContext.request.contextPath}/iqacList"><button type="button" class="btn btn-info"><< Back</button></a>
                    ...
                    <div class="tab-content">
                      ...
                      <div class="col-xs-12"> 
                    		 <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="iqacName" name="iqacName" placeholder="Name" value="${page.pageName}"   required>
                                </div>
                              </div>
                       
                    		  
                    		   <div class="form-group">
                                <label class="control-label col-sm-2" for="status">Select Designation : <span class="text-danger">*</span></label>
                                <div class="col-sm-10">
                         ...
                         <div class="form-group">
                                <label class="control-label col-sm-2" for="heading1">Date Of Joining : <span class="text-danger">*</span></label>
                                <div class="col-sm-10">
                                  <input type="date" class="form-control" id="dateOfJoin" name="dateOfJoin" placeholder="Date Of Joining" value="" required>
                                </div>
                            </div>
