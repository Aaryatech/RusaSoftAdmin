					...
					<section class="box ">
						<header class="panel_header">
							...
							<div class="actions panel_actions pull-right">
								...
								<a href="${pageContext.request.contextPath}/newTrainingAndPlacementOfficer"><button
...
<%
								...
								<form id="deanListForm">
									<table id="example-1"
										...
										<tbody>
										<c:forEach items="${trainOfficrList}"
												var="tpoList" varStatus="count">
												<tr>
											...
											<td style="text-align: left"><c:out
														value="${tpoList.facultyFirstName}" /></td>
											
											<td style="text-align: left"><c:out
														value="${tpoList.qualificationName}" /></td>
										
											<td style="text-align: center"><c:out
														value="${tpoList.joiningDate}" /></td>
										
														
											<td style="text-align: center"><c:out
														value="${tpoList.contactNo}" /></td>
														
											<td style="text-align: left"><c:out
														value="${tpoList.email}" /></td>													
													
													<td align="center">
													<c:if test="${editAccess == 0}"><a
														href="${pageContext.request.contextPath}/editTpo/${tpoList.facultyId}"><span
															class="glyphicon glyphicon-edit" title="Edit"
															data-animate=" animated fadeIn " rel="tooltip"></span></a></c:if> &nbsp;&nbsp;&nbsp;&nbsp;
															
														<c:if test="${deleteAccess == 0}"><a
														href="${pageContext.request.contextPath}/deleteTpo/${tpoList.facultyId}/<%out.println(hashtext);%>"
														...
														data-original-title="Delete  record"><span
														 ...
														 &nbsp;&nbsp;
														<a
														href="#" onclick="blockUser(${tpoList.facultyId})"
