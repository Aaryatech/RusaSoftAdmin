							...
							<div class="row">
								<div class="col-md-12">
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/deleteInstiQuality/0/<%out.println(hashtext);%>"
													...
													<c:forEach items="${instQualList}" var="insQuality"
														...
														<tr>
															<td align="center"><input type="checkbox"
																class="chk" name="qualityId"
																id="qualityIds${count.index+1}"
															...
															<td align="center"><c:if test="${editAccess==0}">
																	<a onclick="showEdit(${insQuality.qualityId})" href="#"><span
																		class="glyphicon glyphicon-edit" title="Edit"
																		data-animate=" animated fadeIn " rel="tooltip"></span></a>&nbsp;&nbsp;&nbsp;&nbsp;
															</c:if> <c:if test="${deleteAccess==0}">
																	<a
																		href="${pageContext.request.contextPath}/deleteInstiQuality/${insQuality.qualityId}/<%out.println(hashtext);%>"
										...
										<input type="hidden" id="qualityId" name="qualityId" value="0">
