...
<%
						...
						<form action="${pageContext.request.contextPath}/deleteBestPrac/0/<%out.println(hashtext);%>"
												...
												<c:forEach items="${pracList}" var="pracList"
													...
													<tr>
														...
														<td style="text-align: center;"><c:if
																...
																&nbsp;&nbsp;&nbsp;&nbsp; <a
																	href="${pageContext.request.contextPath}/deleteBestPrac/${pracList.practicesId}/<%out.println(hashtext);%>"
