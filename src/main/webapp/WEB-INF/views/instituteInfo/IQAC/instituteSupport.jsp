							...
							<div class="row">
								<div class="col-md-12">
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/delInstSupport/0/<%out.println(hashtext);%>"
										method="get" 
												...
												<c:forEach items="${schemeList}" var="schmList"
													...
													<tr>
														...
														<td align="center"><c:if test="${editAccess==0}"> 
																...
																<a
																	href="${pageContext.request.contextPath}/deleteInstituteScheme/${schmList.instSchemeId}/<%out.println(hashtext);%>"
