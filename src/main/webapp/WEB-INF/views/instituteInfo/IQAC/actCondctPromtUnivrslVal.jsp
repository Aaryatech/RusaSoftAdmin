							...
							<div class="row">
								<div class="col-md-12">
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/delActivitiesCndctPrmotUnvrslVal/0"
														...
														<c:forEach items="${actCndctPrgList}" var="actCndctPrgList"
															...
															<tr>
																...
																<td align="center"><c:if test="${editAccess==0}">
																		...
																		<a
																			href="${pageContext.request.contextPath}/deleteActCndctPromtUnivrsalValu/${actCndctPrgList.actCndctId}"
