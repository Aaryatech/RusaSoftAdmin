							...
							<div class="row">
								<div class="col-md-12">
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/delOrgActivities/0/<%out.println(hashtext);%>"
														...
														<c:forEach items="${instActList}" var="activList"
															...
															<tr>
																...
																<td align="center"><c:if test="${editAccess==0}">
																		...
																		<a
																			href="${pageContext.request.contextPath}/deleteActivity/${activList.instActivityId}/<%out.println(hashtext);%>"
