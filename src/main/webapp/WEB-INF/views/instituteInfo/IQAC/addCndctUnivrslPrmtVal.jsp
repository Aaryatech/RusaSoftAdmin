									...
									<form class="form-horizontal"
										...
										<div class="form-group">
											<input type="hidden" id="activityId" name="activityId"
												...
												class="control-label col-sm-2" for="activityType">Title
												of Programme/ Activity <span class="text-danger">*</span>
											</label>
											<div class="col-sm-6">

												<select id="prg_title" name="prg_title" class="form-control"
													required>
													<option value="Truth"
														${actCndct.ttleProgrmAct eq 'Truth' ? 'selected' : '' }>Truth</option>
													<option value="Righteous Conduct"
														${actCndct.ttleProgrmAct eq 'Righteous Conduct' ? 'selected' : '' }>Righteous
														Conduct</option>
													<option value="Love"
														${actCndct.ttleProgrmAct eq 'Love' ? 'selected' : '' }>Love</option>
													<option value="Non Violence and Peace"
														${actCndct.ttleProgrmAct eq 'Non Violence and Peace' ? 'selected' : '' }>Non
														Violence and Peace</option>
													<option value="National Values"
														${actCndct.ttleProgrmAct eq 'National Values' ? 'selected' : '' }>National
														Values</option>
													<option value="Human Values"
														${actCndct.ttleProgrmAct eq 'Human Values' ? 'selected' : '' }>Human
														Values</option>
													<option value="National Integration"
														${actCndct.ttleProgrmAct eq 'National Integration' ? 'selected' : '' }>National
														Integration</option>
													<option value="Communal Harmony"
														${actCndct.ttleProgrmAct eq 'Communal Harmony' ? 'selected' : '' }>Communal
														Harmony</option>
													<option value="Social Cohesion"
														${actCndct.ttleProgrmAct eq 'Social Cohesion' ? 'selected' : '' }>Social
														Cohesion</option>
													<option value="Fundamental Duties"
														${actCndct.ttleProgrmAct eq 'Fundamental Duties' ? 'selected' : '' }>Fundamental
														Duties</option>
												</select>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" class="form-control datepicker"
													...
													value="${actCndct.fromDate}" onFocus="clearDefault(this)">
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" class="form-control datepicker"
													...
													value="${actCndct.toDate}" onFocus="clearDefault(this)">
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" class="form-control" maxlength="7"
													...
													value="${actCndct.noOfParticipant}"
