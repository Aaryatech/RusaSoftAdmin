					...
					<section class="box ">
						...
						<header class="panel_header">
							...
							<div class="actions panel_actions pull-right">
								<a
									href="${pageContext.request.contextPath}/showInitiativeToEngage"><button
								...
								<div class="col-md-12">
									<form class="form-horizontal"
										...
										<div class="form-group">
											<label class="control-label col-sm-2" for="con_name">Contribution
												Name <span class="text-danger">*</span>
											</label>
											<div class="col-sm-6">
												<input type="text" class="form-control" id="con_name"
													autocomplete="off" name="con_name"
													placeholder="Contribution Name " value="${page.pageName}"
													required>
											</div>
										</div>
