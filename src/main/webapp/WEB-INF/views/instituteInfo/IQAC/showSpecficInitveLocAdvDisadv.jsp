...
<body class=" ">
						...
						<header class="panel_header">
							...
							<div class="actions panel_actions pull-right">
								<c:if test="${addAccess == 0}">
									<a
										href="${pageContext.request.contextPath}/addSpecificInitiveLocAdvDisadv"><button
												...
												<table id="example-1" class="table table-striped dt-responsive display">
													...
													<thead>
														<tr>
															...
															<th>To Date</th>
															<th>Issue Address</th>
															<th>No. of Student Participate</th>
															<th>Action</th>
														...
														<c:forEach items="${inItList}" var="inItList"
															...
															<tr>
																<td align="center"><input type="checkbox"
																	class="chk" name="initAdvId"
																	id="initAdvIds${count.index+1}"
																	value="${inItList.spciAdvId}" /></td>
																<td align="center">${count.index+1}</td>
																<td>${inItList.nameOfInitiatives}</td>
																<td align="center">${inItList.fromDate}</td>
																<td align="center">${inItList.toDate}</td>
																<td>${inItList.issueAddress}</td>
																<td>${inItList.noStudPart}</td>

																<td align="center"><c:if test="${editAccess==0}">
																		<a
																			href="${pageContext.request.contextPath}/editInitiative/${inItList.spciAdvId}">
	...
	<script type="text/javascript">
		function selectedInst(source) {
			...
			checkboxes = document.getElementsByName('initAdvId');
