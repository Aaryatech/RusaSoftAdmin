...
public class LibraryInfo {
	...
	private String dateOfPurchaseAutomation; //Date
	...
	private String dateOfPlanningEstablishment;  //Date
	private int isAdministration;
	private String dateOfAdministrationEstablishment;  //Date 
	private int isFinanceAcc;
	private String dateOfFinanceEstablishment;  //Date;
	private int isStudentAdmition;
	private String dateOfStudentEstablishment;  //Date
	private int isExamination;
	private String dateOfExaminationEstablishment;  //Date
	...
	public String getDateOfPurchaseAutomation() {
		return dateOfPurchaseAutomation;
	}
	public void setDateOfPurchaseAutomation(String dateOfPurchaseAutomation) {
	...
	public String getDateOfPlanningEstablishment() {
		return dateOfPlanningEstablishment;
	}
	public void setDateOfPlanningEstablishment(String dateOfPlanningEstablishment) {
	...
	public String getDateOfAdministrationEstablishment() {
		return dateOfAdministrationEstablishment;
	}
	public void setDateOfAdministrationEstablishment(String dateOfAdministrationEstablishment) {
	...
	public String getDateOfFinanceEstablishment() {
		return dateOfFinanceEstablishment;
	}
	public void setDateOfFinanceEstablishment(String dateOfFinanceEstablishment) {
	...
	public String getDateOfStudentEstablishment() {
		return dateOfStudentEstablishment;
	}
	public void setDateOfStudentEstablishment(String dateOfStudentEstablishment) {
	...
	public String getDateOfExaminationEstablishment() {
		return dateOfExaminationEstablishment;
	}
	public void setDateOfExaminationEstablishment(String dateOfExaminationEstablishment) {
